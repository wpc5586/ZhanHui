...
public class MyConvenientBanner<T> extends LinearLayout {
    ...
    public MyConvenientBanner(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
     ...
     * @param visible
     */
    public MyConvenientBanner setPointViewVisible(boolean visible) {
     ...
     * @return
     */
    public MyConvenientBanner setPageIndicatorAlign(PageIndicatorAlign align) {
     ...
     * @return
     */
    public MyConvenientBanner setPageTransformer(PageTransformer transformer) {
     ...
     * @return
     */
    public MyConvenientBanner addOnPageChangeListener(ViewPager.OnPageChangeListener onPageChangeListener) {
     ...
     */
    public MyConvenientBanner setOnItemClickListener(OnItemClickListener onItemClickListener) {
