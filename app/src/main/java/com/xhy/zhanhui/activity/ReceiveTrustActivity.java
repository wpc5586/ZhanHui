...
//        recyclerView.setLayoutManager(linearLayoutManager);
    ...
    public class ReceiveTrustAdapter extends RecyclerView.Adapter<ReceiveTrustHolder> implements View.OnClickListener, View.OnLongClickListener {
        ...
        private void accept(final ReceiveTrustHolder holder) {
            final String requestId = ((ReceiveTrustBean.Obj) holder.data).getHx_username();
            final String acceptId = getHxUserId();
            showProgressDialog("接受中");
            EMClient.getInstance().contactManager().asyncAcceptInvitation(requestId, new EMCallBack() {
                @Override
