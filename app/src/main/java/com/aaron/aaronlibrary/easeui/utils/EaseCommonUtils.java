...
public class EaseCommonUtils {
     ...
     * @param user
     */
    public static void setUserInitialLetter(FriendBean.Obj user) {
        final String DefaultLetter = "#";
        String letter = DefaultLetter;
        ...
        if (letter.equals(DefaultLetter) && !TextUtils.isEmpty(user.getHx_username())) {
            letter = new GetInitialLetter().getLetter(user.getHx_username());
        }
        user.setInitialLetter(letter);
    }
