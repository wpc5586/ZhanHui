    ...
    protected void setEaseUIProviders() {
        ...
        easeUI.getNotifier().setNotificationInfoProvider(new EaseNotificationInfoProvider() {
            ...
            public String getTitle(EMMessage message) {
                ...
                String title = null;
                if (DemoHelper.getInstance().getContactList().get(message.getFrom()) != null) {
                    EaseUser user = DemoHelper.getInstance().getContactList().get(message.getFrom());
            ...
            public String getLatestText(EMMessage message, int fromUsersNum, int messageNum) {
                ...
                String content = null;
                if (DemoHelper.getInstance().getContactList().get(message.getFrom()) != null && messageNum == 1) {
                    content = EaseCommonUtils.getMessageDigest(message, ZhanHuiApplication.applicationContext);
                }
                return content;
            }
...
//                    }
     ...
     * @param aContactList
     */
    public void setContactNeList(Map<String, EaseUser> aContactList) {
        if(aContactList == null){
            if (contactNeList != null) {
                contactNeList.clear();
                contactNeList = null;
            }
            return;
     ...
     * @return
     */
    public Map<String, EaseUser> getContactListNe() {
        if (isLoggedIn() && contactList == null) {
            contactList = DemoDBManager.getInstance().getContactListNe();
        }
  ...
  public void addSyncGroupListener(DataSyncListener listener) {
   ...
   public void asyncFetchBlackListFromServer(final EMValueCallBack<List<String>> callback){
    ...
    public void setSyncingContactsWithServer(boolean syncingContactsWithServer) {
        isSyncingContactsWithServer = syncingContactsWithServer;
    }
    ...
    public void setContactsSyncedWithServer(boolean contactsSyncedWithServer) {
        isContactsSyncedWithServer = contactsSyncedWithServer;
    }
