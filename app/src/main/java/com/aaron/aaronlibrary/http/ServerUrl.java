...
//    public static final String SERVICES = "http://ibp.tunnel.echomod.cn/services/"; // 本地
    ...
    public static String getDocument(String documentId) {
        return getService() + "documents/" + documentId;
    }
    ...
    public static String cancelCollectDocument(String documentId) {
        return getService() + "dataCenter/favorites/" + documentId;
    }
     ...
     * @return 数据
     */
    public static String cancelReservation(String reservationId) {
        return getService() + "reservations/" + reservationId;
    }
