 ...
 */
package com.aaron.aaronlibrary.widget.wheelcity.adapters;
...
import com.aaron.aaronlibrary.viewpagerindicator.DensityUtil;
...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
	...
	/** Default text color */
	public static final int DEFAULT_TEXT_COLOR = 0x474646;
	...
	protected void configureTextView(TextView view) {
		...
		view.setPadding(0, DensityUtil.dip2px(context, 5), 0,
	...
	private TextView getTextView(View view, int textResource) {
		Log.e("--textResource--", textResource+"");
		TextView text = null;
		try {
